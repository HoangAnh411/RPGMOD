...
public class ShieldBreakSkill extends BaseSkill {

    public ShieldBreakSkill() {
        super("shield_break", "Shield Break", 0, 20, 140, "PHYSICAL", 1);
    }
